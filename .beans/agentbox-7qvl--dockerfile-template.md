...
The template is structured as a single `.tmpl` file in a `templates/` subdirectory under `internal/render/`. This keeps template source separate from Go source and scales naturally as sibling beans (agentbox-dttd, agentbox-v9jt, agentbox-v1zh, agentbox-780o) add more templates.
...
- [x] Branch pushed
- [x] PR created (https://github.com/BjRo/agentbox/pull/8)
- [x] Automated code review passed (`@review-backend`)
- [x] Review feedback worked in (agentbox-9ium)
