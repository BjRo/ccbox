...
Explore approaches for bean $ARGUMENTS. Research the problem space, check for prior attempts, and propose 2-3 concrete approaches with tradeoffs. Append an Approach Exploration report to the bean.
