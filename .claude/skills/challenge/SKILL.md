---
name: challenge
description: Stress-test a refined bean's implementation plan from the Go engineer persona. Use after /refine. Pass a bean ID as argument, e.g. /challenge agentbox-abc1
