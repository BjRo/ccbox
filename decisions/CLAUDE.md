...
| 0003 | Separate data registries from behavior packages | 2026-04-02 | Data registries (`internal/stack/`) are leaf packages with read-only accessors; behavior packages import them, never the reverse |
