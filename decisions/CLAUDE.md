...
| 0005 | render.Merge as single merge orchestrator | 2026-04-02 | `render.Merge` orchestrates multi-stack merging into `GenerationConfig`, delegating domain logic to `firewall.Merge` |
| 0006 | Embedded template rendering pattern | 2026-04-02 | embed.FS + text/template + FuncMap + pure rendering functions; two-layer shell injection defense |
