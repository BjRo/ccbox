...
| 0009 | Multi-stage Dockerfile for user customizations | [0009](0009-multi-stage-dockerfile-for-user-customizations.md) | 2026-04-07 | agentbox/custom stage split; `agentbox update` preserves user stage and mise-config.toml |
