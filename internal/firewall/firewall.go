...
var registry = map[Stack]Allowlist{
	AlwaysOn: {
		...
		Domains: []Domain{
			...
			{Name: "auth0.openai.com", Category: Dynamic, Rationale: "OpenAI auth0 - required for Codex ChatGPT token refresh"},
			{Name: "chatgpt.com", Category: Dynamic, Rationale: "ChatGPT - required for Codex ChatGPT login auth flow"},
			{Name: "accounts.openai.com", Category: Dynamic, Rationale: "OpenAI accounts - required for Codex ChatGPT auth"},
